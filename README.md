...
Sample audio generated by codicodec-flow is available in the `examples/` directory:

- `prompt.wav` - Input audio prompt (4 seconds)
- `out_continuation.wav` - Generated continuation (20 seconds)
- `okachihuali_v3_example.wav` - Generated by the v3_okachihuali model trained for 6,860,000 steps on the Akachihuali dataset
...
These examples demonstrate the model's ability to generate coherent musical continuations from a short audio prompt.
